...
26. **Dockerfile Support (Issue \#35)** - Handle extensionless files via
...
`get_diagram_themes` \| List available themes \| \| `putior_guide` \| AI
assistant documentation \| \| `putior_help` \| Quick reference help \|
