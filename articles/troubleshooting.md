...
This guide helps you diagnose and resolve common issues when working
...
**Problem**: [`put()`](https://pjt222.github.io/putior/reference/put.md)
takes too long on large projects.
...
If you don’t have the `logger` package installed, putior works silently
...
1.  **Wrong comment prefix** for file type (see [Multi-Language
    Support](#multi-language-support-issues))
...
**Important**: `.internal` files can only be outputs, never inputs
between scripts.
