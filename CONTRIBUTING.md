...
Open an issue at [github.com/pjt222/putior/issues](https://github.com/pjt222/putior/issues) with:
...
1. **Fork and branch**: Create a feature branch from `main` (e.g., `feature/my-improvement`)
2. **Follow existing style**: Match the coding patterns in the existing codebase
3. **Document**: Add roxygen2 documentation for any new exported functions
4. **Test**: Add testthat tests for new functionality (aim for >80% coverage)
5. **Check**: Run `devtools::check()` and ensure 0 errors, 0 warnings
6. **Describe**: Write a clear PR description explaining the "why" behind your changes
