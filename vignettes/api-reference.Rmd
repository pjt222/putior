...
Returns the programming languages supported by auto-detection.
...
Character vector: `c("r", "python", "sql", "shell", "julia")`
...
- [Getting Started](getting-started.html) - Introduction and basic usage
