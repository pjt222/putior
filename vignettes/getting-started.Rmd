...
**R script example:**
    ...
    # data_processing.R
    #put name:"load_data", label:"Load Customer Data", node_type:"input", output:"raw_data.csv"
    
    # Your actual code
    data <- read.csv("customer_data.csv")
    write.csv(data, "raw_data.csv")
    
    #put name:"clean_data", label:"Clean and Validate", node_type:"process", input:"raw_data.csv", output:"clean_data.csv"
...
**Python script example:**
    ...
    # analysis.py
    #put name:"analyze_sales", label:"Sales Analysis", node_type:"process", input:"clean_data.csv", output:"sales_report.json"
...
example_output <- data.frame(
  ...
  name = c("load_data", "clean_data", "analyze_sales"),
...
PUT annotations support several formats to fit different coding styles:
    ...
    #put name:"my_node", label:"My Process"           # Standard format
    # put name:"my_node", label:"My Process"          # Space after #
    #put| name:"my_node", label:"My Process"          # Pipe separator
    #put name:'my_node', label:'Single quotes'        # Single quotes
    #put name:"my_node", label:'Mixed quotes'         # Mixed quote styles
...
|----------|---------|----------------|
| `name` | Unique identifier | `"load_data"`, `"process_sales"` |
...
Add any properties you need for visualization or metadata:
    ...
    #put name:"train_model", label:"Train ML Model", node_type:"process", color:"green", group:"machine_learning", duration:"45min", priority:"high"
...
### 1. Data Collection (Python)
    ...
    # 01_collect_data.py
    #put name:"fetch_api_data", label:"Fetch Data from API", node_type:"input", output:"raw_api_data.json"
...
### 2. Data Processing (R)
    ...
    # 02_process_data.R  
    #put name:"clean_api_data", label:"Clean and Structure Data", node_type:"process", input:"raw_api_data.json", output:"processed_sales.csv"
...
### 3. Analysis and Reporting (R)
    ...
    # 03_analyze_report.R
    #put name:"sales_analysis", label:"Perform Sales Analysis", node_type:"process", input:"processed_sales.csv", output:"analysis_results.rds"
    #put name:"generate_report", label:"Generate HTML Report", node_type:"output", input:"analysis_results.rds", output:"sales_report.html"
